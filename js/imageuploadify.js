...
;(function($, window, document, undefined) {
  ...
  $.fn.imageuploadify = function(opts) {
    ...
    this.each(function() {
      ...
      addMsg.css("border-top", "1px solid #black");
      addMsg.css("border-bottom", "1px solid #black");
      ...
      button.mouseenter(function onMouseEnter(event) {
        button.css("background", "#777").css("color", "black");
      }).mouseleave(function onMouseLeave() {
        button.css("background", "white").css("color", "#black");
      });
      ...
      dragbox.on("dragenter", function onDragenter(event) {
        ...
        dragbox.css("border-color", "#black");
