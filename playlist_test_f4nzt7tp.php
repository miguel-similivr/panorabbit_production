...
<?php insertTitle(["title" => "Panorabbit Test Playlist"]); ?>
<?php include('panels/showpanels.php'); ?>
<script src="/panels/createpanels.js"></script>

<div class="container home-board" id="playlistcontainer"> 
  <div class="col-lg-12 white-background">
    <div class="col-lg-12 white-background">
      <div class="col-lg-6 col-xs-6"><h4>Test Playlist</h4></div>
    ...
    <div class="white-background">
        ...
        for (var p in objects) {
          createpanel(objects[p], p, "playlistcontainer");
        }
        </script>
      </div>
  </div>
