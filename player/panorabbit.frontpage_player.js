(function() {
  ...
  function main() { 
      jQuery(document).ready(function($) {
        ...
        var contentUrl = 'https://s3-us-west-2.amazonaws.com/panorabbit001/wkenny/bj8zZ2_497836784.975794.jpg';
        var autoPlay = true;
        ...
        $.getScript("player/output.min.js", function(){
          ...
          // WebGL setup.
          var playerContainer = document.getElementById("panorabbit-fp-player-container");
          ...
          function getButtonContainer () {
            var buttonContainer = document.getElementById("panorabbit-fp-player-container");
          ...
          function addHeadingElement () {
            ...
            headingElement.classList.add = "panorabbit-player-heading";
            headingElement.style.color = "#FFF";
            headingElement.style.fontWeight = "normal";
            headingElement.style.backgroundColor = "rgba(0, 0, 0, 0.3)";
            headingElement.style.borderRadius = "0px";
            headingElement.style.border = "none";
            headingElement.style.position = "absolute";
            headingElement.style.cursor = "pointer";
            headingElement.width = "100%";
            headingElement.height = "100%";
            headingElement.top = "0";
            headingElement.left =  "0";
            headingElement.align = "center";

            getButtonContainer().appendChild(headingElement);
          }
